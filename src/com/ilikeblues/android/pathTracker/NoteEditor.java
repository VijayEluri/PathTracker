...
import com.ilikeblues.android.pathTracker.gps.GpsLocationLoader;
import com.ilikeblues.android.pathTracker.gps.GpsLocationLoader.LocationResult;
import com.ilikeblues.android.pathTracker.gps.LocationAddress;
...
public class NoteEditor extends Activity {
    ...
    private static final int COLUMN_INDEX_LOC  = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_EDIT.equals(action)) {
            ...
            // First, try to set the title and location
        ...
        dateText = (TextView) findViewById(R.id.DTTextView);
	...
	private void updateLocation() {
         ...
         * Test location class
         */
        boolean gl = myLocation.getLocation(this, locationResult);
        if (!gl) {
